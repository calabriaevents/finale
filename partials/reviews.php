...
<section id="reviews" class="mt-12">
    <div class="bg-gray-50 p-6 rounded-lg shadow-inner">
        <h2 class="text-2xl font-bold text-gray-800 mb-6 border-b pb-4">Recensioni Utenti</h2>
        ...
        <div class="space-y-6 mb-8">
            <?php if (empty($approved_comments)): ?>
                <p class="text-gray-500">Non ci sono ancora recensioni per questo articolo. Sii il primo a lasciarne una!</p>
            <?php else: ?>
