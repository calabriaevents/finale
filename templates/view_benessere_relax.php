...
$treatments = nl2br(htmlspecialchars($json_data['treatments'] ?? ''));
$opening_hours = nl2br(htmlspecialchars($json_data['opening_hours'] ?? ''));
$price_range = htmlspecialchars($json_data['price_range'] ?? '');
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-2 space-y-12">
                <!-- Description -->
                <section>
                    <h2 class="text-2xl font-bold text-gray-800 mb-4 border-b pb-2">Il Centro Benessere</h2>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof lucide !== 'undefined') {
        lucide.createIcons();
                ...
                <?php if ($treatments): ?>
                <section>
                    <h2 class="text-2xl font-bold text-gray-800 mb-4 border-b pb-2">Trattamenti Offerti</h2>
                    <div class="prose max-w-none text-gray-600">
                        <?php echo $treatments; ?>
                    </div>
        ...
        lucide.createIcons();
                ...
                <section>
                     <div class="p-6 border-2 border-dashed rounded-lg text-center">
                        <h3 class="text-lg font-semibold text-gray-700">Ti sei rilassato qui?</h3>
    ...
    if (typeof lucide !== 'undefined') {
        lucide.createIcons();
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <span class="font-semibold text-gray-800">Prezzi</span>
                                <p class="text-gray-700"><?php echo $price_range; ?></p>
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof lucide !== 'undefined') {
        lucide.createIcons();
                        ...
                        <div class="flex items-center pt-4 border-t mt-4">
