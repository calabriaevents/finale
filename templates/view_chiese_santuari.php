    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-2 space-y-12">
                <!-- Description -->
                <section>
                    <h2 class="text-2xl font-bold text-gray-800 mb-4 border-b pb-2">Descrizione Storico-Architettonica</h2>
                ...
                <div class="sticky top-8 bg-gray-50 p-6 rounded-lg shadow-sm">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <span class="font-semibold text-gray-800">Orari Visite / Messe</span>
        ...
        lucide.createIcons();
                        ...
                        <div class="flex items-start">
                            <i data-lucide="ticket" class="w-5 h-5 text-gray-500 mr-3 mt-1 flex-shrink-0"></i>
                             <div>
                                <span class="font-semibold text-gray-800">Ingresso</span>
