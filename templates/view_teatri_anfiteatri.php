...
$programming = nl2br(htmlspecialchars($json_data['programming'] ?? ''));
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-2 space-y-12">
                <!-- Description -->
                <section>
                    <h2 class="text-2xl font-bold text-gray-800 mb-4 border-b pb-2">Storia e Descrizione</h2>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof lucide !== 'undefined') {
        lucide.createIcons();
                ...
                <?php if ($programming): ?>
                <section>
                    <h2 class="text-2xl font-bold text-gray-800 mb-4 border-b pb-2">Programmazione</h2>
                    <div class="prose max-w-none text-gray-600">
