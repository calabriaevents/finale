...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof lucide !== 'undefined') {
        ...
        <div class="absolute inset-0 flex flex-col justify-center items-center text-center p-8">
            ...
            <p class="text-xl mt-2 text-white/90"><?php echo htmlspecialchars($article['category_name']); ?> a <?php echo htmlspecialchars($article['city_name']); ?></p>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-2 space-y-12">
                <!-- Description -->
                <section>
                    <h2 class="text-2xl font-bold text-gray-800 mb-4 border-b pb-2">Descrizione del Luogo</h2>
        ...
        lucide.createIcons();
            ...
            <aside class="lg:col-span-1">
                <div class="sticky top-8 bg-gray-50 p-6 rounded-lg shadow-sm">
                    <h2 class="text-2xl font-bold text-gray-800 mb-4 border-b pb-2">Posizione</h2>
                    <?php if($maps_link): ?>
                    <div class="mt-6">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof lucide !== 'undefined') {
        lucide.createIcons();
                    ...
                    <?php else: ?>
                    <p class="text-gray-500">Mappa non disponibile.</p>
                    <?php endif; ?>
                </div>
