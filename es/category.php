...
<head>
    ...
    <title><?php echo htmlspecialchars($category['name']); ?> - Passione Calabria</title>
    ...
    <div class="bg-white border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <nav class="breadcrumb">
                ...
                <span class="breadcrumb-item"><a href="categories.php" class="text-blue-600 hover:text-blue-700">Categories</a></span>
                <span class="breadcrumb-item text-gray-900 font-medium"><?php echo htmlspecialchars($category['name']); ?></span>
            </nav>
        </div>
    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center py-20">
                ...
                <p class="text-gray-600 mb-8 max-w-md mx-auto">
                    There are no articles in this category yet, but we are preparing fantastic ones!
                </p>
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    <a href="categories.php" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full font-semibold transition-colors">
