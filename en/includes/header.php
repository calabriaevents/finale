    ...
    <div style="background: rgba(0, 0, 0, 0.1); padding: 0.5rem 0;">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center text-sm">
                ...
                <!-- Language Flags -->
                <div class="flex items-center space-x-2">
                    <span class="text-xs text-blue-200 mr-3">Lingua:</span>
                    <a href="../it/index.php" class="px-2 py-1 bg-white bg-opacity-20 rounded text-sm font-medium hover:bg-opacity-30 transition-colors" title="Italiano">
                        🇮🇹 IT
                    </a>
    ...
    <nav style="position: relative;">
            ...
            <div class="flex justify-between items-center py-4">
                ...
                <div class="hidden lg:flex items-center justify-center flex-1">
                    <div class="flex items-center space-x-8">
                        ...
                        <a href="categorie.php" style="color: white; text-decoration: none; font-weight: 500; padding: 0.5rem 0; transition: color 0.2s;" onmouseover="this.style.color='#fde047'" onmouseout="this.style.color='white'">Categorie</a>
                        <a href="province.php" style="color: white; text-decoration: none; font-weight: 500; padding: 0.5rem 0; transition: color 0.2s;" onmouseover="this.style.color='#fde047'" onmouseout="this.style.color='white'">Province</a>
                        <a href="mappa.php" style="color: white; text-decoration: none; font-weight: 500; padding: 0.5rem 0; transition: color 0.2s;" onmouseover="this.style.color='#fde047'" onmouseout="this.style.color='white'">Mappa</a>
        ...
        <div id="mobile-menu" class="lg:hidden hidden" style="background: rgba(0, 0, 0, 0.2); backdrop-filter: blur(4px);">
            <div style="padding: 1rem; display: flex; flex-direction: column; gap: 0.75rem;">
                ...
                <a href="categorie.php" style="color: white; text-decoration: none; padding: 0.5rem 0; transition: color 0.2s;" onmouseover="this.style.color='#fde047'" onmouseout="this.style.color='white'">Categorie</a>
                <a href="province.php" style="color: white; text-decoration: none; padding: 0.5rem 0; transition: color 0.2s;" onmouseover="this.style.color='#fde047'" onmouseout="this.style.color='white'">Province</a>
                <a href="mappa.php" style="color: white; text-decoration: none; padding: 0.5rem 0; transition: color 0.2s;" onmouseover="this.style.color='#fde047'" onmouseout="this.style.color='white'">Mappa</a>
