...
<head>
    ...
    <title>Cities of Calabria - Passione Calabria</title>
    <meta name="description" content="Explore all the cities of Calabria: from large metropolises to small villages, discover the urban diversity of Calabria.">
    ...
    <div class="bg-white border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <nav class="breadcrumb">
                ...
                <span class="breadcrumb-item text-gray-900 font-medium">Cities</span>
            </nav>
        </div>
    </div>
    ...
    <div class="bg-gradient-to-r from-blue-600 via-teal-500 to-yellow-500 text-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-blue-100 max-w-3xl mx-auto mb-8">
                From large coastal metropolises to small mountain villages, discover the urban diversity that characterizes Calabria. Each city tells a unique story of traditions, culture and natural beauty.
            </p>
            <div class="flex justify-center gap-4 flex-wrap">
                <span class="bg-white/20 backdrop-blur-sm text-white px-4 py-2 rounded-full">
                    <?php echo $totalCities; ?> total cities
                </span>
                <span class="bg-white/20 backdrop-blur-sm text-white px-4 py-2 rounded-full">
                    5 provinces
                </span>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <form method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="md:col-span-3 text-right">
                    ...
                    <a href="cities.php" class="ml-4 text-gray-600 hover:text-gray-800 font-semibold">
                        Clear filters
                    </a>
                    <?php endif; ?>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p class="text-gray-600"><?php echo $cityCount; ?> cities found</p>
                </div>
            ...
            <div class="text-center py-20">
                ...
                <p class="text-gray-600 mb-8 max-w-md mx-auto">
                    Try modifying the search filters or explore all available cities.
                </p>
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 group">
                    <div class="aspect-[4/3] relative overflow-hidden bg-gradient-to-br from-blue-500 to-teal-600">
                        ...
                        <div class="absolute top-4 right-4">
                            <span class="bg-yellow-500 text-white px-3 py-1 rounded-full text-sm font-medium">
                                <?php echo $articleCount; ?> articles
                            </span>
                        </div>
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">
                            <?php echo htmlspecialchars($city['description'] ?: 'City of ' . $city['province_name']); ?>
                        </p>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="city-detail.php?id=<?php echo $city['id']; ?>" class="text-blue-600 hover:text-blue-700 font-semibold flex items-center transition-colors">
            ...
            <div id="cities-list" class="space-y-4 hidden">
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 hover:shadow-lg transition-shadow">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="ml-6">
                            <a href="city-detail.php?id=<?php echo $city['id']; ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-semibold transition-colors inline-flex items-center">
                                Explore
