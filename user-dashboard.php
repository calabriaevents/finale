                    ...
                    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                        ...
                        <div class="px-6 py-3 bg-gray-50 text-center">
                            <p class="text-sm text-gray-600">
                                ...
                                Visualizzati gli ultimi 20 utilizzi. Per assistenza: <strong>+39°°°°°°°°°</strong>
                            </p>
                        </div>
                    </div>
                    <?php endif; ?>
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg p-6">
                        ...
                        <p class="text-sm text-blue-100 mb-3">
                            Per qualsiasi modifica alla pagina personalizzata, contattaci:
                        </p>
                        <p class="font-bold text-lg">+39°°°°°°°°°</p>
