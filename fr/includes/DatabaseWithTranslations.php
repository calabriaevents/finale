<?php
/**
 * Wrapper Database con Traduzioni
 * 
 * Estende la funzionalità della classe Database esistente.
 * Le traduzioni sono solo manuali tramite admin panel.
 */
...
class DatabaseWithTranslations extends Database {
    ...
    private $translationsEnabled = false; // Sempre disabilitato - solo manuale
    
    public function __construct() {
        parent::__construct();
        $this->translationsEnabled = false; // Solo traduzioni manuali
    }
