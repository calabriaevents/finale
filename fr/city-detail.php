...
// Load other cities from the same province
...
<head>
    ...
    <title><?php echo htmlspecialchars($city['name']); ?> - Cities of Calabria</title>
    <meta name="description" content="<?php echo htmlspecialchars($city['description'] ?: 'Discover ' . $city['name'] . ', city in the province of ' . $city['province_name'] . ' in Calabria.'); ?>">
...
<body class="bg-gray-50">
    ...
    <div class="bg-white border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <nav class="breadcrumb">
                ...
                <span class="breadcrumb-item"><a href="cities.php" class="text-blue-600 hover:text-blue-700">Cities</a></span>
                <span class="breadcrumb-item"><a href="province.php?id=<?php echo $city['province_id']; ?>" class="text-blue-600 hover:text-blue-700"><?php echo htmlspecialchars($city['province_name']); ?></a></span>
    ...
    <div class="bg-gradient-to-r from-blue-600 via-teal-500 to-yellow-500 text-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-blue-100 max-w-3xl mx-auto mb-8">
                <?php echo htmlspecialchars($city['description'] ?: 'City in the province of ' . $city['province_name']); ?>
            </p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-16">
                <h2 class="text-3xl font-bold text-gray-900 mb-8 text-center">
                    Location of <?php echo htmlspecialchars($city['name']); ?>
                </h2>
                <div class="bg-white rounded-2xl shadow-lg p-8">
                    <div class="mb-6">
                        <p class="text-gray-600 text-center mb-4">
                            Explore the location of <?php echo htmlspecialchars($city['name']); ?> on the interactive map.
                        </p>
                    </div>
                    <div id="city-map" class="w-full h-96 bg-gray-100 rounded-lg overflow-hidden">
                        <!-- Leaflet city-specific map -->
                    </div>
                    <div class="mt-4 text-center">
                        <p class="text-sm text-gray-500">
                            Coordinates: <?php echo $city['latitude']; ?>, <?php echo $city['longitude']; ?>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-16">
                <h2 class="text-3xl font-bold text-gray-900 mb-8 text-center">
                    Articles about <?php echo htmlspecialchars($city['name']); ?>
                </h2>
            ...
            <div class="text-center py-20">
                ...
                <p class="text-gray-600 mb-8 max-w-md mx-auto">
                    There are no articles yet for <?php echo htmlspecialchars($city['name']); ?>, but we're preparing some amazing content!
                </p>
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    <a href="cities.php" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full font-semibold transition-colors">
            ...
            <div class="mt-16">
                <h3 class="text-2xl font-bold text-gray-900 mb-8 text-center">
                    Other Cities in <?php echo htmlspecialchars($city['province_name']); ?>
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    ?>
                    <a href="city-detail.php?id=<?php echo $relatedCity['id']; ?>" 
                       class="block bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-all group">
                        ...
                        <p class="text-gray-600 text-sm mb-4">
                            <?php echo htmlspecialchars(substr($relatedCity['description'] ?: 'City in ' . $city['province_name'], 0, 80)); ?>...
                        </p>
                        <div class="flex items-center justify-between">
                            <span class="text-xs text-gray-500">
                                <?php echo $relatedArticleCount; ?> articles
                            </span>
    ...
    <script>
        ...
        // Initialize city map if present
        ...
        function initCityMap() {
            ...
            const cityData = {
                ...
                description: <?php echo json_encode($city['description'] ?: 'City in ' . $city['province_name']); ?>,
            ...
            marker.bindPopup(`
                <div class="p-2">
                    ...
                    <p class="text-sm text-gray-500">Province of ${cityData.province}</p>
                </div>
            `).openPopup();
            <?php else: ?>
