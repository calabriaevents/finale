    ...
    <div class="bg-gray-900 text-white w-64 flex flex-col">
        ...
        <nav class="flex-1 p-4 overflow-y-auto">
            <ul class="space-y-2">
                ...
                <li>
                    <a href="gestione-pacchetti.php" class="flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-gray-700 transition-colors">
                        <i data-lucide="package" class="w-5 h-5"></i>
                        <span>Gestione Pacchetti</span>
                    </a>
                </li>
                <li>
                    <a href="articoli.php" class="flex items-center space-x-3 px-3 py-2 rounded-lg bg-gray-700 text-white">
