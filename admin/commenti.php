                ...
                <table class="w-full">
                    <thead>
                        <tr class="border-b bg-gray-50">
                            ...
                            <th class="text-left py-3 px-2">Articolo</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="py-3 px-2 text-sm"><a href="../articolo.php?slug=<?php echo $comment['article_slug'] ?? ''; ?>" target="_blank" class="text-blue-600 hover:underline"><?php echo htmlspecialchars($comment['article_title']); ?></a></td>
                            <td class="py-3 px-2">
                                <?php
                                $statusColors = [
