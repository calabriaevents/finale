...
try {
    ...
    try {
        ...
        // 3. Somma totale
        $totalRevenue = $subscriptionRevenue + $consumptionRevenue;
        ...
        <main class="flex-1 overflow-auto p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 mb-8">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-xs text-gray-400">01/10/2025</p>
                            ...
                            <p class="text-sm text-gray-500">Abbonamenti + Crediti</p>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-600">Guadagni Mese Corrente</p>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-600">Guadagni Mese Precedente</p>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-600">Guadagni Anno Corrente</p>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-600">Guadagni Anno Precedente</p>
