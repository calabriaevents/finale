...
<!-- Basic Info -->
<div class="mb-4">
    <label for="title" class="block text-gray-700 font-bold mb-2">Nome Chiesa / Santuario</label>
...
<div class="mt-6 p-6 bg-purple-50 rounded-lg border border-purple-200">
    <h3 class="text-lg font-semibold mb-4 text-purple-800">🏛️ Dettagli Religiosi</h3>

    <div class="mb-4">
        <label for="opening_hours" class="block text-gray-700 font-bold mb-2">Orari di Visita / Messe</label>
        ...
        <p class="text-xs text-gray-500 mt-1">Un giorno per riga. Es: <strong>Feriali: 08:00-12:00. Festivi: 09:00-11:00, 18:00-19:30</strong></p>
    </div>
    <div class="mb-4">
        <label for="ticket_info" class="block text-gray-700 font-bold mb-2">Costo Ingresso (se presente)</label>
        <input type="text" name="json_data[ticket_info]" id="ticket_info" class="w-full px-3 py-2 border rounded-lg" value="<?php echo htmlspecialchars($json_data['ticket_info'] ?? 'Ingresso libero'); ?>">
    </div>
</div>
...
<!-- Description -->
<div class="mt-6 p-6 bg-gray-50 rounded-lg border">
    <h3 class="text-lg font-semibold mb-4 text-gray-800">📝 Descrizione Storico-Architettonica</h3>
