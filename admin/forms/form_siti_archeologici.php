...
<!-- Basic Info -->
<div class="mb-4">
    <label for="title" class="block text-gray-700 font-bold mb-2">Nome Sito Archeologico</label>
...
<div class="mt-6 p-6 bg-purple-50 rounded-lg border border-purple-200">
    ...
    <div class="mb-4">
     ...
     <div class="mb-4">
        <label for="exhibitions" class="block text-gray-700 font-bold mb-2">Eventi Speciali / Tour Guidati</label>
