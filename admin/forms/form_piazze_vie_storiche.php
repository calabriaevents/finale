...
<!-- Basic Info -->
<div class="mb-4">
    <label for="title" class="block text-gray-700 font-bold mb-2">Nome Piazza / Via</label>
...
<div class="mt-6 p-6 bg-purple-50 rounded-lg border border-purple-200">
    <h3 class="text-lg font-semibold mb-4 text-purple-800">🏛️ Dettagli</h3>
    <p class="text-sm text-gray-600">Per questa categoria, la maggior parte delle informazioni si trova nella descrizione principale.</p>
</div>
