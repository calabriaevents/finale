...
<!-- Basic Info -->
<div class="mb-4">
    <label for="title" class="block text-gray-700 font-bold mb-2">Nome Teatro / Anfiteatro</label>
...
<div class="mt-6 p-6 bg-purple-50 rounded-lg border border-purple-200">
    <h3 class="text-lg font-semibold mb-4 text-purple-800">🎭 Dettagli Teatro</h3>

    <div class="mb-4">
        <label for="programming" class="block text-gray-700 font-bold mb-2">Programmazione Spettacoli</label>
        <textarea name="json_data[programming]" id="programming" rows="6" class="w-full px-3 py-2 border rounded-lg"><?php echo htmlspecialchars($json_data['programming'] ?? ''); ?></textarea>
        <p class="text-xs text-gray-500 mt-1">Inserisci qui il programma degli eventi, le date e gli orari.</p>
    </div>
    <div class="mb-4">
        <label for="ticket_info" class="block text-gray-700 font-bold mb-2">Informazioni Biglietti</label>
        <textarea name="json_data[ticket_info]" id="ticket_info" rows="3" class="w-full px-3 py-2 border rounded-lg"><?php echo htmlspecialchars($json_data['ticket_info'] ?? ''); ?></textarea>
         <p class="text-xs text-gray-500 mt-1">Es: <strong>Botteghino aperto dalle 10:00 alle 18:00. Acquisto online su...</strong></p>
    </div>
</div>
...
<div class="mt-6 p-6 bg-gray-50 rounded-lg border">
    ...
    <?php
        $predefined_services = ['Guardaroba', 'Bar Interno', 'Accesso Disabili'];
