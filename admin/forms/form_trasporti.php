...
<!-- Basic Info -->
<div class="mb-4">
    <label for="title" class="block text-gray-700 font-bold mb-2">Nome Servizio di Trasporto</label>
...
<!-- Custom Fields for Transport -->
<div class="mt-6 p-6 bg-gray-200 rounded-lg border border-gray-300">
    <h3 class="text-lg font-semibold mb-4 text-gray-800">🚌 Dettagli Trasporto</h3>

    <div class="mb-4">
        <label for="fares" class="block text-gray-700 font-bold mb-2">Tariffe</label>
        <textarea name="json_data[fares]" id="fares" rows="4" class="w-full px-3 py-2 border rounded-lg"><?php echo htmlspecialchars($json_data['fares'] ?? ''); ?></textarea>
        <p class="text-xs text-gray-500 mt-1">Es. Corsa singola: 1.50€, Abbonamento giornaliero: 5€</p>
    </div>
</div>
...
<div class="mt-6 p-6 bg-gray-50 rounded-lg border">
    ...
    <?php
        $predefined_services = ['Noleggio con Conducente', 'Tour Guidati', 'Navette', 'Noleggio Auto'];
...
<!-- Contacts -->
<div class="mt-6 p-6 bg-gray-50 rounded-lg border">
    <h3 class="text-lg font-semibold mb-4 text-gray-800">📍 Contatti</h3>
...
<!-- Description -->
<div class="mt-6 p-6 bg-gray-50 rounded-lg border">
    <h3 class="text-lg font-semibold mb-4 text-gray-800">📝 Descrizione Servizio</h3>
...
<!-- Images -->
<div class="mt-6 p-6 bg-gray-50 rounded-lg border">
    <h3 class="text-lg font-semibold mb-4 text-gray-800">🖼️ Immagini (Mezzi, etc.)</h3>
     <div class="mb-6">
        <label for="logo" class="block text-gray-700 font-bold mb-2">Logo Compagnia</label>
